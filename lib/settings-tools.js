 ...
 */
import { DESCRIPTION_MAX_LENGTH, EXEC_TIMEOUT_MS, QUERY_TIMEOUT_MS, STATS_TIMEOUT_MS, resolveSettings, splitConnectionsByEnv, } from './config.js';
...
export function buildSettingsTools() {
    ...
    const sqlConfigSet = {
        name: 'sql_config_set',
        description: '改全局设置：activeEnv / environments / maxRows，至少一个入参。立即生效，不用重启。\n' +
